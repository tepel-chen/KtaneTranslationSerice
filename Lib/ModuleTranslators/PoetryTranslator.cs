...
namespace TranslationService.ModuleTranslators
{
    class PoetryTranslator : ModuleTranslator
    {
        ...
        public override void StartTranslation(KMBombModule module, Translator translator)
        {
            ...
            {
                {translator.GetTranslation("Melanie", moduleName),translator.GetTranslation("clarity", moduleName),translator.GetTranslation("flow", moduleName),translator.GetTranslation("fatigue", moduleName),translator.GetTranslation("hollow", moduleName),translator.GetTranslation("Jane", moduleName)},
                ...
                {translator.GetTranslation("Hana", moduleName),translator.GetTranslation("cookies", moduleName),translator.GetTranslation("compassion", moduleName),translator.GetTranslation("creation", moduleName),translator.GetTranslation("patience", moduleName),translator.GetTranslation("Lacy", moduleName)}
            };
